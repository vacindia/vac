...
<html lang="en">
<head>
    <title>Matrimonial | New Entry</title>
...
<div class="testbox">
    ...
    <form action="submitnewentry" method="post" autocomplete="off" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false">
        <center>
            <button type="button" class="homebutton green" onclick="window.location.href='index'">Home</button><br><br>
        </center>
        <div class="colums">
            <div class="item">
            ...
            <div class="item">
                ...
                <input id="homecity" type="text" name="homecity" value="" />
            </div>
            ...
            <div class="item">
                ...
                <input id="currentcity" type="text" name="currentcity" value="" />
            </div>

            <div class="item">
                <label for="detailededucation">Education (in detail)<span>*</span></label>
                <input id="detailededucation" type="text" name="detailededucation" value="" />
            </div>
            ...
            <div class="item">
                ...
                <input id="reemail" type="text" name="reemail" value="" />
            </div>
            ...
            <div class="item">
                ...
                <select name="bodytype" >
                    <option selected value="" disabled selected>Body Type<span>*</span></option>
                ...
                <select name="complexion" >
                    <option selected value="" disabled selected>Complexion<span>*</span></option>
            ...
            <div class="item">
                <select name="physicalstatus" >
                    <option selected value="" disabled selected>Physical Status<span>*</span></option>
                ...
                <select name="eatinghabit" >
                    <option selected value="" disabled selected>Eating Habit<span>*</span></option>
            ...
            <div class="item">
                ...
                <input id="subcaste" type="text" name="subcaste" value="" />
            </div>

            <div class="item">
                <select name="smokinghabit" >
                    <option selected value="" disabled selected>Smoking Habit<span>*</span></option>
                ...
                <select name="drinkinghabit" >
                    <option selected value="" disabled selected>Drinking Habit<span>*</span></option>
            ...
            <div class="item">
                ...
                <input id="gothra" type="text" name="gothra" value="" />
            </div>

            <div class="item">
                <select name="familyvalue" >
                    <option selected value="" disabled selected>Your Family Value<span>*</span></option>
                ...
                <select name="familytype" >
                    <option selected value="" disabled selected>Family Type<span>*</span></option>
            ...
            <div class="item">
                ...
                <input id="mothertongue" type="text" name="mothertongue" value=""  />
            </div>

            <div class="item">
                <select name="familystatus" >
                    <option selected value="" disabled selected>Your Family Status<span>*</span></option>
            ...
            <div class="item">
                ...
                <select name="annualincome" >
                    <option selected value="No Income at the moment" selected>No Income at the moment</option>
            ...
            <div class="item">
                ...
                <input id="moreabout" type="text" name="moreabout" value=""  />
            </div>
            ...
            <div class="item">
                ...
                <input id="expectation" type="text" name="expectation" value=""  />
            </div>

            <div class="item">
                <p>Dhosham / Mangalik</p>
                <select name="dhosham">
                    <option selected value="Do not Know" selected>Do not Know</option>
            ...
            <div class="item">
                ...
                <input id="siblings" type="text" name="siblings" value=""  />
            </div>

            <div class="item">
                <label for="height">Height<span>*</span></label>
                <input id="height" placeholder="eg. 5ft 6inch OR 170Cms" type="text" name="height" value=""  />
            </div>
            ...
            <div class="item">
                ...
                <input id="weight" placeholder="in Kg" type="text" name="weight" value=""  />
            </div>

            <div class="item">
                <label for="repass">Re-type Password<span>*</span></label>
                <input id="repass" type="password" name="repass" value=""  />
            </div>

            <div class="item">
                <label for="referredby">How do you know about us?<span>*</span></label>
                <input id="referredby" placeholder="eg. Friend or Google Search" type="text" name="referredby" value=""  />
            </div>
        ...
        <center>
            <p style="color: red">
            Please re-check all the data entered by you because after clicking <b>SUBMIT</b> button, all fields are cleared.
            </p>
        </center>
        <br>
        <div class="btn-block">
